import { monthlyEquivalent } from './calculations.js'

export function buildSpendingTimeline(subscriptions, rangeDays = 365) {
...
export function pointsToPath(points, width = 300, height = 100) {
  if (points.length === 0) {
